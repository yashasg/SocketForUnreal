...
namespace CustomNetworking
{
    ...
    /// 
    /// If we have an open Socket s, we can create a SS by doing
    /// 
    ///    SS ss = new SS(s, new UTF8Encoding());
    /// 
    /// We can write a string to the SS by doing
    /// 
